export function CtaSection() {
  return (
    <section className="flex relative flex-col items-start self-center px-28 py-20 mt-20 w-full bg-indigo-500 rounded-2xl max-w-[1216px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
      <div className="flex z-0 flex-col items-center self-center max-w-full w-[768px]">
        ...
        <div className="flex gap-4 justify-center items-start pt-4 mt-6 max-w-full text-sm font-medium leading-5 text-indigo-500 w-[513px]">
          <button className="overflow-hidden gap-2 self-stretch px-7 py-3.5 bg-white rounded-lg w-[184px] max-md:px-5">
            Book a Demo
          </button>
        </div>
      </div>
