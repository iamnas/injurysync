...
//             <button className="cursor-pointer w-full md:w-auto overflow-hidden gap-2 self-stretch px-5 md:px-7 py-3.5 my-auto text-white bg-indigo-600 rounded-lg shadow-sm">
//               Get Started
//             </button>
//             <button className="w-full cursor-pointer md:w-auto flex overflow-hidden gap-2 justify-center items-center self-stretch py-3.5 px-5 md:px-7 my-auto bg-gray-50 rounded-lg shadow-sm text-slate-700">
//               <img
//                 src="play.png"
//                 alt="Demo icon"
...
export function HeroSection() {
  return (
    <section className="flex hero-section flex-col w-full min-h-[1171px] max-md:min-h-fit relative">
      {/* Background Layer */}
