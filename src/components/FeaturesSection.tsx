...
//           </h3>
//           <p className="mt-4 text-base md:text-lg text-[#475467] leading-relaxed">
...
//         onClick={onClick}
//       >
//         <h4 className="text-2xl md:text-2xl font-semibold text-center text-gray-900">
//           {title}
//         </h4>
//         <p className="mt-2 text-sm md:text-base text-center text-[#475467] leading-relaxed">
//           {description}
//         </p>
//       </div>
//     );
  ...
  return (
    <section className="flex flex-col items-center px-6 md:px-28 py-20 w-full bg-white">
      <div className="flex flex-col text-center w-full max-w-3xl">
        ...
        <div className="flex flex-col items-center mt-4 w-full">
          <h3 className="text-3xl sm:text-3xl lg:text-5xl font-bold text-gray-900 leading-tight md:leading-[62px]">
            Everything <span className="text-[#465FFF]">You</span> Hate About{" "}
            <br className="hidden md:block" />
            <span className="text-[#465FFF]">Pre Lit Intake</span>—Solved
          </h3>
