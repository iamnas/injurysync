...
//       {/* Background layers for mobile view */}
//       <div className="lg:hidden fixed top-0 left-0 right-0 h-64 z-0 overflow-hidden">
//         <div className="absolute top-0 left-0 w-full h-full bg-[#ECF3FF]"></div>
//         <div className="absolute -top-12 -left-12 w-64 h-64 rounded-full bg-[#E5EDFF] opacity-60"></div>
//         <div className="absolute top-20 -right-24 w-96 h-96 rounded-full bg-[#E0E8FF] opacity-50"></div>
//       </div>
